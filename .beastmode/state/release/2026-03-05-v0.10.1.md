...
Converts ungated HITL interactions in retro and release merge into proper configurable gates, enabling fully autonomous feature cycles when all gates are set to auto.
