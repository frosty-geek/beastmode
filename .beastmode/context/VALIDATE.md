...
- Baseline as of 2026-04-04 (post dashboard-wiring-fix): 72 test files passing, 21 type errors (pre-existing in untouched test files — worktree.test.ts adds 1 vs prior flashy-dashboard baseline of 20)
