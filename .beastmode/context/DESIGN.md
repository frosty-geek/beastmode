...
9. ALWAYS use standardized frontmatter across all phase artifacts — `phase`, `id` (entity identifier), `epic` (human name) always present; phase-specific additions per phase
