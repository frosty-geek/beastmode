...
## Architecture
System design with fractal L0/L1/L2/L3 knowledge hierarchy, four data domains (Product/Context/State/Meta), worktree isolation for implementation, unified cycle commits, two-tier HITL gate system (HARD-GATE + configurable Gate steps), and artifact-based context persistence across sessions.
